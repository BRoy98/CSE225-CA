...
public class DataPass1Fragment extends Fragment {

    private FragmentDataSender mDataSender;
    private TextView receiveText;

    public DataPass1Fragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
        final View root = inflater.inflate(R.layout.fragment_data_pass_1, container, false);
        ...
        sendData.setOnClickListener(v -> {
            ...
            mDataSender.sendMessage(2, input);
            sendText.setText("");
        });
        return root;
    }
